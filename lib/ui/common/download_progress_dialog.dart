...
//   /// Static helper to show the dialog, handle lifecycle, and auto-close.
...
//     // When the task completes (success or error), we close the dialog
//     // if it is still open and wasn't cancelled by the user manually.
...
//     // 3. Show the Dialog (Blocking call for the UI)
//     await showDialog(
//       context: context,
...
//     // If the user cancelled, this will throw DownloadCanceledException.
//     // If download failed, this will throw the error.
//     // If successful, this completes normally.
//     await taskFuture;
//   }
